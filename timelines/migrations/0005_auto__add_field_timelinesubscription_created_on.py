...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TimelineSubscription.created_on'
        db.add_column(u'timelines_timelinesubscription', 'created_on',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2014, 5, 14, 0, 0), auto_now_add=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TimelineSubscription.created_on'
        db.delete_column(u'timelines_timelinesubscription', 'created_on')
    ...
    models = {
        ...
        u'timelines.timelinesubscription': {
            ...
            'created_on': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 5, 14, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
