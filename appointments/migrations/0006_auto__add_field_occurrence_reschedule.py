...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Occurrence.reschedule'
        db.add_column(u'appointments_occurrence', 'reschedule',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'occurrences', null=True, to=orm['appointments.Occurrence']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Occurrence.reschedule'
        db.delete_column(u'appointments_occurrence', 'reschedule_id')
